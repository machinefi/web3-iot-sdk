...
#include <layer_iotex/psa_util.h>

#if defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG)

#include <string.h>
#include <layer_iotex/entropy.h> 
...
#include "layer_iotex/ctr_drbg.h"

#elif defined(IOTEX_HMAC_DRBG_C)

#include "layer_iotex/hmac_drbg.h"
 ...
 */
static inline void iotex_psa_drbg_free( mbedtls_psa_drbg_context_t *p_rng )
{
#if defined(IOTEX_CTR_DRBG_C)
